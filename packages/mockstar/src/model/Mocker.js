...
export default class Mocker {
    ...
    constructor(basePath) {
        ...
        // config.json 的内容
        const config = requireModule(path.join(this.basePath, './config'));
