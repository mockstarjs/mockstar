 ...
 */
function MockerConfig(handlerName) {
  var _this = this;

  var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var mockModuleList = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

  _classCallCheck(this, MockerConfig);
  ...
  if (mockModuleList && mockModuleList.length) {
    var firstMockModuleName = mockModuleList[0].name;
    ...
    if (!this.activeModule) {
      ...
      var activeItem = mockModuleList.filter(function (item) {
        return item.name === _this.activeModule;
      })[0];
...
//# sourceMappingURL=MockerConfig.js.map